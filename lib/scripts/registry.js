...
describe('YlideRegistry', function () {
    it('Should deploy', async function () {
        const YlideRegistryV5 = await hardhat_1.ethers.getContractFactory('YlideRegistryV5');
        const registry = await YlideRegistryV5.deploy('0x0000000000000000000000000000000000000000');
