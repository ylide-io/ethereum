...
class EthereumBlockchainController extends sdk_1.AbstractBlockchainController {
    ...
    async advancedRetrieveMessageHistoryByBounds(sender, recipient, fromMessage, fromMessageIncluding = false, toMessage, toMessageIncluding = false, limit) {
        return this.iterateMailers(limit, mailer => this._retrieveMessageHistoryByBounds(mailer.address, { type: sdk_1.BlockchainSourceType.DIRECT, sender, recipient }, fromMessage, fromMessageIncluding, toMessage, toMessageIncluding, limit));
    }
    async _retrieveMessageHistoryByBounds(mailerAddress, subject, fromMessage, fromMessageIncluding = false, toMessage, toMessageIncluding = false, limit) {
    ...
    async retrieveMessageHistoryByBounds(sender, recipient, fromMessage, toMessage, limit) {
        return this.iterateMailers(limit, mailer => this._retrieveMessageHistoryByBounds(mailer.address, { type: sdk_1.BlockchainSourceType.DIRECT, sender, recipient }, fromMessage, false, toMessage, false, limit));
    }
    ...
    async retrieveBroadcastHistoryByBounds(sender, fromMessage, toMessage, limit) {
        return this.iterateMailers(limit, mailer => this._retrieveMessageHistoryByBounds(mailer.address, { type: sdk_1.BlockchainSourceType.BROADCAST, sender }, fromMessage, false, toMessage, false, limit));
    }
