...
class EthereumBlockchainController extends sdk_1.AbstractBlockchainController {
    ...
    async retrieveMessageHistoryByBounds(sender, recipient, fromMessage, toMessage, limit) {
        return this.iterateMailers(limit, mailer => this._retrieveMessageHistoryByBounds(mailer.address, { type: sdk_1.BlockchainSourceType.DIRECT, sender, recipient }, fromMessage, toMessage, limit));
    }
    ...
    async retrieveBroadcastHistoryByBounds(sender, fromMessage, toMessage, limit) {
        return this.iterateMailers(limit, mailer => this._retrieveMessageHistoryByBounds(mailer.address, { type: sdk_1.BlockchainSourceType.BROADCAST, sender }, fromMessage, toMessage, limit));
    }
