    ...
    constructor(options = {}) {
        ...
        this.mailerContractAddress =
            options.mailerContractAddress ||
                (options.dev ? constants_1.DEV_MAILER_ADDRESS : constants_1.EVM_CONTRACTS[this.network].mailer.address);
        this.registryContractAddress =
            options.registryContractAddress ||
                (options.dev ? constants_1.DEV_REGISTRY_ADDRESS : constants_1.EVM_CONTRACTS[this.network].registry.address);
    }
